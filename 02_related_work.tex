...
geometry-based control, hierarchical imitation, and reinforcement learning.
...
terrain heights of a few segments ahead of, below and behind the robot, trained in a 2D
simulation and sampled on the robot from a LiDAR point-cloud map built with
A-LOAM~\cite{loam2014,aloam}. Their reward favors smooth pitch only, and getting stuck is a terminal
...
Pecka~\cite{pecka2016} & safety-constrained REPS & reimpl. & \cmark & p & \xmark \\
