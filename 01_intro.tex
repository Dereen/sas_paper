...
\begin{figure}[t]
  ...
  \end{tikzpicture}
  \caption{\textbf{The onboard and ground-truth map on a pallet.} (a) The robot climbing a
...
the chassis pitches and drops abruptly, saturating the IMU; therefore, inertial integration cannot
...
\begin{enumerate}
  ...
  \item We perform the large comparison in a real obstacle arena with AprilTag ground
