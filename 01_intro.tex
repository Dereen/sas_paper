...
Where the estimate of that ground drifts, due to body occlusion, the commanded flipper
...
\begin{enumerate}
  ...
  the \emph{onboard} map, in a large comparison in Gazebo of \SAS{} against \emph{twelve}
